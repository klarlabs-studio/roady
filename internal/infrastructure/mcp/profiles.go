...
var toolGroups = map[string]toolGroup{
	...
	"roady_get_snapshot":       groupCore,
	"roady_get_spec":           groupCore,
	"roady_get_plan":           groupCore,
	"roady_get_state":          groupCore,
	"roady_add_feature":        groupCore,
	"roady_explain_spec":       groupCore,
	"roady_review_spec":        groupCore,
	"roady_spec_validate":      groupCore,
	"roady_spec_lock":          groupCore,
	"roady_spec_analyze":       groupCore,
	"roady_spec_import":        groupCore,
	"roady_generate_plan":      groupCore,
	"roady_update_plan":        groupCore,
	"roady_approve_plan":       groupCore,
	"roady_plan_reject":        groupCore,
	"roady_plan_prune":         groupCore,
	"roady_plan_decompose":     groupCore,
	"roady_tasks":              groupCore,
	"roady_transition_task":    groupCore,
	"roady_dispatch_task":      groupCore,
	"roady_task_log_time":      groupCore,
	"roady_detect_drift":       groupCore,
	"roady_accept_drift":       groupCore,
	"roady_explain_drift":      groupCore,
	"roady_check_policy":       groupCore,
	"roady_state_rebuild":      groupCore,
	"roady_suggest_priorities": groupCore,
	...
	"roady_record_semantic_drift": groupAnalytics,
